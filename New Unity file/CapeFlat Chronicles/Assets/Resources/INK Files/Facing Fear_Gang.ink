...
* I’d keep my head high and walk with confidence.
    -> AddEdu
    "Good move, bru. Fear respect confidence, maar jy moet watch jou back."
    -> Fear_Challenge_Complete

* I’d stay low, making sure no one can spot me.
    -> AddGang
    "Smart, jy weet how to survive. Maar onthou, jy can’t always hide."
    -> Fear_Challenge_Complete
...
// Branch: Learning to Deal with Fear
= Learning_To_Deal_With_Fear
